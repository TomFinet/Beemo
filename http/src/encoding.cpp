...
namespace beemo
{
    ...
    */
    ...
    bool decode_identity(std::string_view raw_content, req *const request)
    {
        return true;
    }
        
    bool decode_gzip(std::string_view raw_content, req *const request)
    {
        return true;
    }

    bool decode_compress(std::string_view raw_content, req *const request)
    {
        return true;
    }

    bool decode_deflate(std::string_view raw_content, req *const request)
    {
        return true;
    }
}